            ...
            return {
                ...
                models: [
                    ...
                    },
                    {
                        ...
                        shader: 'color',
                        material: {
                            color: vec3.fromValues(0.5, 0.5, 0.1),  // red, green, blue
                            specular: vec3.fromValues(1.0, 1.0, 1.0),  // red, green, blue
                            shininess: 20
                        },
                    ...
                    },
                    {
                        ...
                        shader: 'color',
                        material: {
                            color: vec3.fromValues(0.0, 0.5, 0.0),  // red, green, blue
                            specular: vec3.fromValues(1.0, 1.0, 1.0),  // red, green, blue
                            shininess: 40
                        },
                        center: vec3.fromValues(0.8, 2.0, -6.0), // x, y, z
                        size: vec3.fromValues(1, 1, 1),  // width, height, depth
                        rotate_x: 0,
                        rotate_y: 0,
                        rotate_z: 0
                ...
                light: {
                    ...
                    point_lights: [
                        ...
                        {
                            position: vec3.fromValues(2, 1.0, -3),  // x, y, z
                            color: vec3.fromValues(1.0, 1.0, 0.8)  // red, green, blue
                        },
                        
                        {
                            position: vec3.fromValues(0, 1.0, -3),  // x, y, z
                            color: vec3.fromValues(1.0, 1.0, 0.8)  // red, green, blue
                        }
                    ]
                }
